...
class SubscriptionProductMeteredFeesService
{
    ...
    public function getSubscriptionsProductsMeteredFeesWithHttpInfo($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFees'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\ProductMeteredFeeListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\ProductMeteredFeeListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\ProductMeteredFeeListResponse', []),
            ...
            $returnType = '\VRPayment\Sdk\Model\ProductMeteredFeeListResponse';
    ...
    public function getSubscriptionsProductsMeteredFeesIdWithHttpInfo($id, $space, $expand = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\ProductMeteredFee' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\ProductMeteredFee' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\ProductMeteredFee', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\ProductMeteredFee';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getSubscriptionsProductsMeteredFeesSearchWithHttpInfo($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\ProductMeteredFeeSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\ProductMeteredFeeSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\ProductMeteredFeeSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\ProductMeteredFeeSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \VRPayment\Sdk\Model\ProductMeteredFeeUpdate $product_metered_fee_update (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchSubscriptionsProductsMeteredFeesId'] to see the possible values for this operation
     *
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
