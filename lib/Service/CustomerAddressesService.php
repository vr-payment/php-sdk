...
class CustomerAddressesService
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\VRPayment\Sdk\Model\CustomerAddressListResponse',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\CustomerAddress|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\CustomerAddress|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\CustomerAddressSearchResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\CustomerAddressSearchResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomersCustomerIdAddressesSearchWithHttpInfo(int $customer_id, int $space, ?array $expand = null, ?int $limit = null, ?int $offset = null, ?string $order = null, ?string $query = null, string $contentType = self::contentTypes['getCustomersCustomerIdAddressesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\VRPayment\Sdk\Model\CustomerAddressSearchResponse',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @param int $id id (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \VRPayment\Sdk\Model\CustomerAddressActive $customer_address_active customer_address_active (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\CustomerAddress|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
    public function patchCustomersCustomerIdAddressesId(int $customer_id, int $id, int $space, \VRPayment\Sdk\Model\CustomerAddressActive $customer_address_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdAddressesId'][0])
    {
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\CustomerAddress|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchCustomersCustomerIdAddressesIdWithHttpInfo(int $customer_id, int $id, int $space, \VRPayment\Sdk\Model\CustomerAddressActive $customer_address_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdAddressesId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchCustomersCustomerIdAddressesIdRequest(int $customer_id, int $id, int $space, \VRPayment\Sdk\Model\CustomerAddressActive $customer_address_active, ?array $expand = null, string $contentType = self::contentTypes['patchCustomersCustomerIdAddressesId'][0])
    {
     ...
     * @param int $customer_id customer_id (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \VRPayment\Sdk\Model\CustomerAddressCreate $customer_address_create customer_address_create (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @return \VRPayment\Sdk\Model\CustomerAddress|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
    public function postCustomersCustomerIdAddresses(int $customer_id, int $space, \VRPayment\Sdk\Model\CustomerAddressCreate $customer_address_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdAddresses'][0])
    {
     ...
     * @return array of \VRPayment\Sdk\Model\CustomerAddress|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCustomersCustomerIdAddressesWithHttpInfo(int $customer_id, int $space, \VRPayment\Sdk\Model\CustomerAddressCreate $customer_address_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdAddresses'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postCustomersCustomerIdAddressesRequest(int $customer_id, int $space, \VRPayment\Sdk\Model\CustomerAddressCreate $customer_address_create, ?array $expand = null, string $contentType = self::contentTypes['postCustomersCustomerIdAddresses'][0])
    {
