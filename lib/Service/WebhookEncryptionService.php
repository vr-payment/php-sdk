...
class WebhookEncryptionService {
	 ...
	 * @return \VRPay\Sdk\Model\WebhookEncryptionPublicKey
	 */
	...
	public function readWithHttpInfo($id) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\WebhookEncryptionPublicKey',
				'/webhook-encryption/read'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\WebhookEncryptionPublicKey', $response->getHeaders()));
