...
class SubscriptionProductMeteredFeeTiersService
{
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\ProductMeteredFeeTierListResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\ProductMeteredFeeTierListResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\VRPayment\Sdk\Model\ProductMeteredFeeTierListResponse',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\ProductMeteredTierFee|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\ProductMeteredTierFee|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\ProductMeteredFeeTierSearchResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\ProductMeteredFeeTierSearchResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscriptionsProductsMeteredFeesFeeIdTiersSearchWithHttpInfo(int $fee_id, int $space, ?array $expand = null, ?int $limit = null, ?int $offset = null, ?string $order = null, ?string $query = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesFeeIdTiersSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\VRPayment\Sdk\Model\ProductMeteredFeeTierSearchResponse',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @param int $id id (required)
     * @param int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update product_metered_tier_fee_update (required)
     * @param string[]|null $expand expand (optional)
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\ProductMeteredTierFee|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
    public function patchSubscriptionsProductsMeteredFeesFeeIdTiersId(int $fee_id, int $id, int $space, \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\ProductMeteredTierFee|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchSubscriptionsProductsMeteredFeesFeeIdTiersIdWithHttpInfo(int $fee_id, int $id, int $space, \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchSubscriptionsProductsMeteredFeesFeeIdTiersIdRequest(int $fee_id, int $id, int $space, \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['patchSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
     ...
     * @return \VRPayment\Sdk\Model\ProductMeteredTierFee|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
    public function postSubscriptionsProductsMeteredFeesFeeIdTiers(int $fee_id, int $space, \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
     ...
     * @return array of \VRPayment\Sdk\Model\ProductMeteredTierFee|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postSubscriptionsProductsMeteredFeesFeeIdTiersWithHttpInfo(int $fee_id, int $space, \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsProductsMeteredFeesFeeIdTiersRequest(int $fee_id, int $space, \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
