...
class SubscriptionProductMeteredFeeTiersService
{
    ...
    public function getSubscriptionsProductsMeteredFeesFeeIdTiersWithHttpInfo($fee_id, $space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesFeeIdTiers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\ProductMeteredFeeTierListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\ProductMeteredFeeTierListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\ProductMeteredFeeTierListResponse', []),
            ...
            $returnType = '\VRPayment\Sdk\Model\ProductMeteredFeeTierListResponse';
    ...
    public function getSubscriptionsProductsMeteredFeesFeeIdTiersIdWithHttpInfo($fee_id, $id, $space, $expand = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesFeeIdTiersId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\ProductMeteredTierFee' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\ProductMeteredTierFee' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\ProductMeteredTierFee', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\ProductMeteredTierFee';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getSubscriptionsProductsMeteredFeesFeeIdTiersSearchWithHttpInfo($fee_id, $space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getSubscriptionsProductsMeteredFeesFeeIdTiersSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\ProductMeteredFeeTierSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\ProductMeteredFeeTierSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\ProductMeteredFeeTierSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\ProductMeteredFeeTierSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \VRPayment\Sdk\Model\ProductMeteredTierFeeUpdate $product_metered_tier_fee_update (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchSubscriptionsProductsMeteredFeesFeeIdTiersId'] to see the possible values for this operation
     *
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
