...
class TransactionLineItemVersionsService
{
     ...
     */
    public function postPaymentTransactionsLineItemVersions(int $space, \VRPayment\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsLineItemVersions'][0])
    {
     ...
     */
    public function postPaymentTransactionsLineItemVersionsWithHttpInfo(int $space, \VRPayment\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsLineItemVersions'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTransactionsLineItemVersionsRequest(int $space, \VRPayment\Sdk\Model\TransactionLineItemVersionCreate $transaction_line_item_version_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTransactionsLineItemVersions'][0])
    {
