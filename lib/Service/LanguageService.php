...
class LanguageService {
	 ...
	 * @return \VRPay\Sdk\Model\RestLanguage[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\RestLanguage[]',
				'/language/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\RestLanguage[]', $response->getHeaders()));
