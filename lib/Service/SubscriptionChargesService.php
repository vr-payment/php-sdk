...
class SubscriptionChargesService
{
     ...
     */
    public function postSubscriptionsCharges(int $space, \VRPayment\Sdk\Model\SubscriptionChargeCreate $subscription_charge_create, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsCharges'][0])
    {
     ...
     */
    public function postSubscriptionsChargesWithHttpInfo(int $space, \VRPayment\Sdk\Model\SubscriptionChargeCreate $subscription_charge_create, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsCharges'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSubscriptionsChargesRequest(int $space, \VRPayment\Sdk\Model\SubscriptionChargeCreate $subscription_charge_create, ?array $expand = null, string $contentType = self::contentTypes['postSubscriptionsCharges'][0])
    {
