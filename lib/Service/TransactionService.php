...
class TransactionService {
	 ...
	 * @param \VRPay\Sdk\Model\TransactionPending $transaction_model The transaction JSON object to update and confirm. (required)
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \VRPay\Sdk\Model\TransactionCreate $transaction The transaction object which should be created. (required)
	 * @throws \VRPay\Sdk\ApiException
	 * @throws \VRPay\Sdk\VersioningException
	 * @throws \VRPay\Sdk\Http\ConnectionException
	 * @return \VRPay\Sdk\Model\Transaction
	...
	public function fetchPaymentMethodsWithHttpInfo($space_id, $id, $integration_mode) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\PaymentMethodConfiguration[]',
				'/transaction/fetch-payment-methods'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\PaymentMethodConfiguration[]', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \VRPay\Sdk\Model\EntityQuery $query The query restricts the transactions which are returned by the search. (required)
	 * @throws \VRPay\Sdk\ApiException
	 * @throws \VRPay\Sdk\VersioningException
	 * @throws \VRPay\Sdk\Http\ConnectionException
	 * @return \VRPay\Sdk\Model\Transaction[]
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \VRPay\Sdk\Model\TransactionPending $entity The transaction object with the properties which should be updated. (required)
	 * @throws \VRPay\Sdk\ApiException
	 * @throws \VRPay\Sdk\VersioningException
	 * @throws \VRPay\Sdk\Http\ConnectionException
	 * @return \VRPay\Sdk\Model\Transaction
