...
class PaymentTerminalsService
{
     ...
     */
    public function patchPaymentTerminalsId(int $id, int $space, \VRPayment\Sdk\Model\PaymentTerminalUpdate $payment_terminal_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTerminalsId'][0])
    {
     ...
     */
    public function patchPaymentTerminalsIdWithHttpInfo(int $id, int $space, \VRPayment\Sdk\Model\PaymentTerminalUpdate $payment_terminal_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTerminalsId'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchPaymentTerminalsIdRequest(int $id, int $space, \VRPayment\Sdk\Model\PaymentTerminalUpdate $payment_terminal_update, ?array $expand = null, string $contentType = self::contentTypes['patchPaymentTerminalsId'][0])
    {
     ...
     * @return \VRPayment\Sdk\Model\PaymentTerminal|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
    public function postPaymentTerminals(int $space, \VRPayment\Sdk\Model\PaymentTerminalCreate $payment_terminal_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTerminals'][0])
    {
     ...
     * @return array of \VRPayment\Sdk\Model\PaymentTerminal|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function postPaymentTerminalsWithHttpInfo(int $space, \VRPayment\Sdk\Model\PaymentTerminalCreate $payment_terminal_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTerminals'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPaymentTerminalsRequest(int $space, \VRPayment\Sdk\Model\PaymentTerminalCreate $payment_terminal_create, ?array $expand = null, string $contentType = self::contentTypes['postPaymentTerminals'][0])
    {
