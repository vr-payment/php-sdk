...
class PaymentConnectorService {
	 ...
	 * @return \VRPay\Sdk\Model\PaymentConnector[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\PaymentConnector[]',
				'/payment-connector/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\PaymentConnector[]', $response->getHeaders()));
