...
class CurrencyService {
	 ...
	 * @return \VRPay\Sdk\Model\RestCurrency[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\RestCurrency[]',
				'/currency/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\RestCurrency[]', $response->getHeaders()));
