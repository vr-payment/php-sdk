...
class SubscriptionSuspensionsService
{
     ...
     * @return \VRPayment\Sdk\Model\SuspensionListResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\SuspensionListResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscriptionsSuspensionsWithHttpInfo($space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getSubscriptionsSuspensions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\SuspensionListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\SuspensionListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\SuspensionListResponse', []),
            ...
            $returnType = '\VRPayment\Sdk\Model\SuspensionListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VRPayment\Sdk\Model\SuspensionListResponse',
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\SubscriptionSuspension|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\SubscriptionSuspension|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VRPayment\Sdk\Model\SuspensionSearchResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VRPayment\Sdk\Model\SuspensionSearchResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse|\VRPayment\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscriptionsSuspensionsSearchWithHttpInfo($space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getSubscriptionsSuspensionsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\SuspensionSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\SuspensionSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\SuspensionSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\SuspensionSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VRPayment\Sdk\Model\SuspensionSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
