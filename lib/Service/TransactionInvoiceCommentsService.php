...
class TransactionInvoiceCommentsService
{
    ...
    public function getPaymentTransactionsInvoicesInvoiceIdCommentsWithHttpInfo($invoice_id, $space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getPaymentTransactionsInvoicesInvoiceIdComments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\InvoiceCommentListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\InvoiceCommentListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\InvoiceCommentListResponse', []),
            ...
            $returnType = '\VRPayment\Sdk\Model\InvoiceCommentListResponse';
    ...
    public function getPaymentTransactionsInvoicesInvoiceIdCommentsIdWithHttpInfo($invoice_id, $id, $space, $expand = null, string $contentType = self::contentTypes['getPaymentTransactionsInvoicesInvoiceIdCommentsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\TransactionInvoiceComment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\TransactionInvoiceComment' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\TransactionInvoiceComment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\TransactionInvoiceComment';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getPaymentTransactionsInvoicesInvoiceIdCommentsSearchWithHttpInfo($invoice_id, $space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getPaymentTransactionsInvoicesInvoiceIdCommentsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\InvoiceCommentSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\InvoiceCommentSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\InvoiceCommentSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\InvoiceCommentSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \VRPayment\Sdk\Model\TransactionInvoiceCommentActive $transaction_invoice_comment_active (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchPaymentTransactionsInvoicesInvoiceIdCommentsId'] to see the possible values for this operation
     *
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @param  int $invoice_id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \VRPayment\Sdk\Model\TransactionInvoiceCommentCreate $transaction_invoice_comment_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPaymentTransactionsInvoicesInvoiceIdComments'] to see the possible values for this operation
     *
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
