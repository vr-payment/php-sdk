...
class LabelDescriptionGroupService {
	 ...
	 * @return \VRPay\Sdk\Model\LabelDescriptorGroup[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\LabelDescriptorGroup[]',
				'/label-description-group-service/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\LabelDescriptorGroup[]', $response->getHeaders()));
