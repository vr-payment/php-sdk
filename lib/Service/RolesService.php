...
class RolesService
{
    ...
    public function getRolesWithHttpInfo($after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getRoles'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\RoleListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\RoleListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\RoleListResponse', []),
            ...
            $returnType = '\VRPayment\Sdk\Model\RoleListResponse';
    ...
    public function getRolesIdWithHttpInfo($id, $expand = null, string $contentType = self::contentTypes['getRolesId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\Role' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\Role' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\Role', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\Role';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    public function getRolesSearchWithHttpInfo($expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getRolesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VRPayment\Sdk\Model\RoleSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\VRPayment\Sdk\Model\RoleSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VRPayment\Sdk\Model\RoleSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\VRPayment\Sdk\Model\RoleSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  int $id (required)
     * @param  \VRPayment\Sdk\Model\RoleUpdate $role_update (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchRolesId'] to see the possible values for this operation
     *
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     *
     * @param  \VRPayment\Sdk\Model\RoleCreate $role_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postRoles'] to see the possible values for this operation
     *
     * @throws \VRPayment\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
