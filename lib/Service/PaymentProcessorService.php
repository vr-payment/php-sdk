...
class PaymentProcessorService {
	 ...
	 * @return \VRPay\Sdk\Model\PaymentProcessor[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\PaymentProcessor[]',
				'/payment-processor/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\PaymentProcessor[]', $response->getHeaders()));
