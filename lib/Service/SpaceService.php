...
class SpaceService {
	 ...
	 * Create
	 *
	 * @param \VRPay\Sdk\Model\SpaceCreate $entity The space object with the properties which should be created. (required)
	 * @throws \VRPay\Sdk\ApiException
	 * @throws \VRPay\Sdk\VersioningException
	 * @throws \VRPay\Sdk\Http\ConnectionException
	...
	public function createWithHttpInfo($entity) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\VRPay\Sdk\Model\Space',
				'/space/create'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\VRPay\Sdk\Model\Space', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 * Search
	 *
	 * @param \VRPay\Sdk\Model\EntityQuery $query The query restricts the spaces which are returned by the search. (required)
	 * @throws \VRPay\Sdk\ApiException
	 * @throws \VRPay\Sdk\VersioningException
	 * @throws \VRPay\Sdk\Http\ConnectionException
	 * @return \VRPay\Sdk\Model\Space[]
	 ...
	 * Update
	 *
	 * @param \VRPay\Sdk\Model\SpaceUpdate $entity The space object with all the properties which should be updated. The id and the version are required properties. (required)
	 * @throws \VRPay\Sdk\ApiException
	 * @throws \VRPay\Sdk\VersioningException
	 * @throws \VRPay\Sdk\Http\ConnectionException
	 * @return \VRPay\Sdk\Model\Space
