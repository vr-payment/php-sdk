...
class ChargeBankTransactionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ChargeBankTransaction[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ChargeBankTransaction[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ChargeBankTransaction[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
