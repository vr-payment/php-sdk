...
class PaymentAppProcessor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \VRPayment\Sdk\Model\ChargeAttemptEnvironment|null $configured_environment configured_environment
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\PaymentAppProcessorState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\PaymentAppProcessorState|null $state state
     *
     * @return self
     */
