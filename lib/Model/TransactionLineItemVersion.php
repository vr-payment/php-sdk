...
class TransactionLineItemVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItem[]|null $line_items The line items that replace the original line items in the transaction.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\TransactionLineItemVersionState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\TransactionLineItemVersionState|null $state state
     *
     * @return self
     */
