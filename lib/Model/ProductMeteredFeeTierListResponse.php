...
class ProductMeteredFeeTierListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ProductMeteredTierFee[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ProductMeteredTierFee[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ProductMeteredTierFee[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
