...
class InvoiceCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\TransactionInvoiceComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\TransactionInvoiceComment[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\TransactionInvoiceComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
