...
class SubscriptionLedgerEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets taxes
     *
     * @param \VRPayment\Sdk\Model\Tax[]|null $taxes A set of tax lines, each of which specifies a tax applied to the ledger entry.
     *
     * @return self
     */
     ...
     * Sets fee_type
     *
     * @param \VRPayment\Sdk\Model\ProductFeeType|null $fee_type fee_type
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\SubscriptionLedgerEntryState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\SubscriptionLedgerEntryState|null $state state
     *
     * @return self
     */
