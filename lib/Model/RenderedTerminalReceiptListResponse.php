...
class RenderedTerminalReceiptListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\RenderedTerminalReceipt[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\RenderedTerminalReceipt[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\RenderedTerminalReceipt[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
