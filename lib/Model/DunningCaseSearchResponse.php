...
class DunningCaseSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\DunningCase[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\DunningCase[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\DunningCase[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
