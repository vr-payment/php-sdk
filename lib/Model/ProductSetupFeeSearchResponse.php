...
class ProductSetupFeeSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ProductSetupFee[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ProductSetupFee[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ProductSetupFee[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
