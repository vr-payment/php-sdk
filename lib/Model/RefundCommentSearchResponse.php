...
class RefundCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\RefundComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\RefundComment[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\RefundComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
