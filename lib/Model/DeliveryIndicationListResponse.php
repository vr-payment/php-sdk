...
class DeliveryIndicationListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\DeliveryIndication[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\DeliveryIndication[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\DeliveryIndication[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
