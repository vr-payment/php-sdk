...
class SingleSignOnUserSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SingleSignOnUser[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\SingleSignOnUser[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SingleSignOnUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
