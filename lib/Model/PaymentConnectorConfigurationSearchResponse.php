...
class PaymentConnectorConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\PaymentConnectorConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\PaymentConnectorConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
