...
class RefundCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets reductions
     *
     * @return \VRPayment\Sdk\Model\LineItemReductionCreate[]|null
     */
     ...
     * Sets reductions
     *
     * @param \VRPayment\Sdk\Model\LineItemReductionCreate[]|null $reductions The reductions applied on the original transaction items, detailing specific adjustments associated with the refund.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \VRPayment\Sdk\Model\RefundType $type type
     *
     * @return self
     */
