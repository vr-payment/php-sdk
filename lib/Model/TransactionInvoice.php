...
class TransactionInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItem[]|null $line_items The invoiced line items that will appear on the invoice document.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\TransactionInvoiceState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\TransactionInvoiceState|null $state state
     *
     * @return self
     */
