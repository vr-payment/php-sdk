...
class LineItemCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'attributes' => 'array<string,\VRPayment\Sdk\Model\LineItemAttributeCreate>',
    ...
    */
     ...
     * Gets taxes
     *
     * @return \VRPayment\Sdk\Model\TaxCreate[]|null
     */
     ...
     * Sets taxes
     *
     * @param \VRPayment\Sdk\Model\TaxCreate[]|null $taxes A set of tax lines, each of which specifies a tax applied to the item.
     *
     * @return self
     */
     ...
     * Gets attributes
     *
     * @return array<string,\VRPayment\Sdk\Model\LineItemAttributeCreate>|null
     */
     ...
     * Sets attributes
     *
     * @param array<string,\VRPayment\Sdk\Model\LineItemAttributeCreate>|null $attributes A map of custom information for the item.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \VRPayment\Sdk\Model\LineItemType $type type
     *
     * @return self
     */
