...
class MetricUsageListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\MetricUsage[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\MetricUsage[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\MetricUsage[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
