...
class WebhookListenerSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\WebhookListener[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\WebhookListener[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\WebhookListener[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
