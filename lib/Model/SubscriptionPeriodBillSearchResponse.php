...
class SubscriptionPeriodBillSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionPeriodBill[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\SubscriptionPeriodBill[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionPeriodBill[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
