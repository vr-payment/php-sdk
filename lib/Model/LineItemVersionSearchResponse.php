...
class LineItemVersionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\TransactionLineItemVersion[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\TransactionLineItemVersion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
