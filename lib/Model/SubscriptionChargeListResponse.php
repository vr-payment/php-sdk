...
class SubscriptionChargeListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionCharge[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\SubscriptionCharge[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionCharge[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
