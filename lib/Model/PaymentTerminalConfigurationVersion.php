...
class PaymentTerminalConfigurationVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets configuration
     *
     * @return \VRPayment\Sdk\Model\PaymentTerminalConfiguration|null
     */
     ...
     * Sets configuration
     *
     * @param \VRPayment\Sdk\Model\PaymentTerminalConfiguration|null $configuration configuration
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\PaymentTerminalConfigurationVersionState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\PaymentTerminalConfigurationVersionState|null $state state
     *
     * @return self
     */
