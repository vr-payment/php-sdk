...
class TerminalTransactionSummarySearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\PaymentTerminalTransactionSummary[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\PaymentTerminalTransactionSummary[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\PaymentTerminalTransactionSummary[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
