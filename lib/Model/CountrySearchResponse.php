...
class CountrySearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\RestCountry[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\RestCountry[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\RestCountry[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
