...
class PaymentLinkSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\PaymentLink[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\PaymentLink[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\PaymentLink[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
