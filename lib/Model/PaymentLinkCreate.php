...
class PaymentLinkCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItemCreate[]|null $line_items The line items representing what is being sold. If not specified, they can be supplied via request parameters.
     *
     * @return self
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentLinkProtectionMode $protection_mode protection_mode
     *
     * @return self
     */
