...
class ProductRetirementListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionProductRetirement[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\SubscriptionProductRetirement[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionProductRetirement[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
