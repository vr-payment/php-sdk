...
class LabelDescriptorListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\LabelDescriptor[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\LabelDescriptor[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\LabelDescriptor[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
