...
class ProductPeriodFeeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets period_fee
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmountUpdate[]|null $period_fee The amount charged to the customer for each billing cycle during the term of a subscription.
     *
     * @return self
     */
