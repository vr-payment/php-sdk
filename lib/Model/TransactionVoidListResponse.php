...
class TransactionVoidListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\TransactionVoid[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\TransactionVoid[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\TransactionVoid[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
