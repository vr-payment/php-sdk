...
class TransactionCompletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \VRPayment\Sdk\Model\TransactionLineItemVersion|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\TransactionLineItemVersion|null $line_item_version line_item_version
     *
     * @return self
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\LineItem[]|null $base_line_items The original line items from the transaction that serve as the baseline for this completion.
     *
     * @return self
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\LineItem[]|null $remaining_line_items The line items yet to be captured in the transaction.
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param \VRPayment\Sdk\Model\LineItem[]|null $line_items The line items captured in this transaction completion.
     *
     * @return self
     */
     ...
     * Gets mode
     *
     * @return \VRPayment\Sdk\Model\TransactionCompletionMode|null
     */
     ...
     * Sets mode
     *
     * @param \VRPayment\Sdk\Model\TransactionCompletionMode|null $mode mode
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\TransactionCompletionState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\TransactionCompletionState|null $state state
     *
     * @return self
     */
