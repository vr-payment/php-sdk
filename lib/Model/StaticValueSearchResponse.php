...
class StaticValueSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\StaticValue[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\StaticValue[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\StaticValue[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
