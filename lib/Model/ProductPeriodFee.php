...
class ProductPeriodFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets period_fee
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmount[]|null $period_fee The amount charged to the customer for each billing cycle during the term of a subscription.
     *
     * @return self
     */
