...
class CurrencyListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\RestCurrency[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\RestCurrency[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\RestCurrency[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
