...
class SuspensionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionSuspension[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\SubscriptionSuspension[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionSuspension[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
