...
class ChargeFlowLevelPaymentLinkSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ChargeFlowLevelPaymentLink[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ChargeFlowLevelPaymentLink[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ChargeFlowLevelPaymentLink[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
