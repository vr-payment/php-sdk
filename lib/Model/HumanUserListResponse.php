...
class HumanUserListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\HumanUser[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\HumanUser[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\HumanUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
