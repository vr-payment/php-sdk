...
class ProductComponentGroupSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionProductComponentGroup[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionProductComponentGroup[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
