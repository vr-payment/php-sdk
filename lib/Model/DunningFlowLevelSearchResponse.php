...
class DunningFlowLevelSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\DunningFlowLevel[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\DunningFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\DunningFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
