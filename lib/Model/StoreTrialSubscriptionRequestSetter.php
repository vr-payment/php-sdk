...
class StoreTrialSubscriptionRequestSetter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'coupon_codes' => 'string[]',
        'component_configurations' => '\VRPayment\Sdk\Model\SubscriptionComponentGroupConfigurationRequestSetter[]',
        'product_id' => 'int',
        'currency' => 'string',
        'affiliate_id' => 'int'
    ];
    ...
    */
     ...
     *
     * @return \VRPayment\Sdk\Model\SubscriptionComponentGroupConfigurationRequestSetter[]|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\SubscriptionComponentGroupConfigurationRequestSetter[]|null $component_configurations component_configurations
     *
     * @return self
     */
