...
class Space implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets database
     *
     * @return \VRPayment\Sdk\Model\TenantDatabase|null
     */
     ...
     * Sets database
     *
     * @param \VRPayment\Sdk\Model\TenantDatabase|null $database database
     *
     * @return self
     */
     ...
     * Gets postal_address
     *
     * @return \VRPayment\Sdk\Model\SpaceAddress|null
     */
     ...
     * Sets postal_address
     *
     * @param \VRPayment\Sdk\Model\SpaceAddress|null $postal_address postal_address
     *
     * @return self
     */
     ...
     * Gets account
     *
     * @return \VRPayment\Sdk\Model\Account|null
     */
     ...
     * Sets account
     *
     * @param \VRPayment\Sdk\Model\Account|null $account account
     *
     * @return self
     */
