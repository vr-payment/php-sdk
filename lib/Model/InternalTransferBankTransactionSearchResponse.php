...
class InternalTransferBankTransactionSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\InternalTransferBankTransaction[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\InternalTransferBankTransaction[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\InternalTransferBankTransaction[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
