...
class MetricUsageReportSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionMetricUsageReport[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\SubscriptionMetricUsageReport[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionMetricUsageReport[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
