...
class TransactionVoid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets mode
     *
     * @return \VRPayment\Sdk\Model\TransactionVoidMode|null
     */
     ...
     * Sets mode
     *
     * @param \VRPayment\Sdk\Model\TransactionVoidMode|null $mode mode
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\TransactionVoidState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\TransactionVoidState|null $state state
     *
     * @return self
     */
