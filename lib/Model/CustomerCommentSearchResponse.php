...
class CustomerCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\CustomerComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\CustomerComment[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\CustomerComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
