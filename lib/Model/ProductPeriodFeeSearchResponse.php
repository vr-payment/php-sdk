...
class ProductPeriodFeeSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ProductPeriodFee[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ProductPeriodFee[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ProductPeriodFee[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
