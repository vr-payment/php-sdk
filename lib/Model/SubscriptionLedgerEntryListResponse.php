...
class SubscriptionLedgerEntryListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionLedgerEntry[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionLedgerEntry[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
