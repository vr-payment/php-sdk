...
class RestAddressFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \VRPayment\Sdk\Model\RestAddressFormatField[]|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\RestAddressFormatField[]|null $required_fields The fields that are required in the address format.
     *
     * @return self
     */
     ...
     * Sets used_fields
     *
     * @param \VRPayment\Sdk\Model\RestAddressFormatField[]|null $used_fields The fields that are used in the address format.
     *
     * @return self
     */
