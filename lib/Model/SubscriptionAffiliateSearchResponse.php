...
class SubscriptionAffiliateSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\SubscriptionAffiliate[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\SubscriptionAffiliate[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
