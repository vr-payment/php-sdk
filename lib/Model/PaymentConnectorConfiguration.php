...
class PaymentConnectorConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentMethodConfiguration|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentMethodConfiguration|null $payment_method_configuration payment_method_configuration
     *
     * @return self
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\SalesChannel[]|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\SalesChannel[]|null $enabled_sales_channels The sales channels for which the connector configuration is enabled. If empty, it is enabled for all sales channels.
     *
     * @return self
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentProcessorConfiguration|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentProcessorConfiguration|null $processor_configuration processor_configuration
     *
     * @return self
     */
     ...
     * Gets connector
     *
     * @return \VRPayment\Sdk\Model\PaymentConnector|null
     */
     ...
     * Sets connector
     *
     * @param \VRPayment\Sdk\Model\PaymentConnector|null $connector connector
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\CreationEntityState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\CreationEntityState|null $state state
     *
     * @return self
     */
     ...
     * Gets conditions
     *
     * @return \VRPayment\Sdk\Model\Condition[]|null
     */
     ...
     * Sets conditions
     *
     * @param \VRPayment\Sdk\Model\Condition[]|null $conditions Conditions allow to define criteria that a transaction must fulfill in order for the connector configuration to be considered for processing the payment.
     *
     * @return self
     */
