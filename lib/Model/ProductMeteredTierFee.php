...
class ProductMeteredTierFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets metered_fee
     *
     * @return \VRPayment\Sdk\Model\ProductMeteredFee|null
     */
     ...
     * Sets metered_fee
     *
     * @param \VRPayment\Sdk\Model\ProductMeteredFee|null $metered_fee metered_fee
     *
     * @return self
     */
     ...
     * Sets fee
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmount[]|null $fee The amount charged to the customer for each consumed unit at the end of a billing cycle.
     *
     * @return self
     */
