...
class ChargeFlowLevelListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ChargeFlowLevel[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ChargeFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ChargeFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
