...
class ManualTaskSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ManualTask[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ManualTask[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ManualTask[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
