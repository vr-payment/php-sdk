...
class TransactionCommentSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\TransactionComment[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\TransactionComment[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\TransactionComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
