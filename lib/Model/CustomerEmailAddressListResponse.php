...
class CustomerEmailAddressListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\RestCustomerEmailAddress[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\RestCustomerEmailAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\RestCustomerEmailAddress[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
