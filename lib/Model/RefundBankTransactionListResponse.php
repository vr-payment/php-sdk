...
class RefundBankTransactionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\RefundBankTransaction[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\RefundBankTransaction[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\RefundBankTransaction[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
