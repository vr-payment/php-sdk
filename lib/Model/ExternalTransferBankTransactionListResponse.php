...
class ExternalTransferBankTransactionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\VRPayment\Sdk\Model\ExternalTransferBankTransaction[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \VRPayment\Sdk\Model\ExternalTransferBankTransaction[]|null
     */
     ...
     * Sets data
     *
     * @param \VRPayment\Sdk\Model\ExternalTransferBankTransaction[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
