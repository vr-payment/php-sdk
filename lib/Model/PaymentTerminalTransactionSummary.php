...
class PaymentTerminalTransactionSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentTerminalTransactionSum[]|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentTerminalTransactionSum[]|null $transaction_sums The total monetary amounts of all transactions, organized and grouped by brand and currency.
     *
     * @return self
     */
     ...
     *
     * @return \VRPayment\Sdk\Model\PaymentTerminalDccTransactionSum[]|null
     */
     ...
     *
     * @param \VRPayment\Sdk\Model\PaymentTerminalDccTransactionSum[]|null $dcc_transaction_sums Detailed breakdown of Dynamic Currency Conversion (DCC) transactions, showing transaction amounts in both original and converted currencies, grouped by payment brand.
     *
     * @return self
     */
