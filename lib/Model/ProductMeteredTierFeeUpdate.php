...
class ProductMeteredTierFeeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets fee
     *
     * @param \VRPayment\Sdk\Model\PersistableCurrencyAmountUpdate[]|null $fee The amount charged to the customer for each consumed unit at the end of a billing cycle.
     *
     * @return self
     */
