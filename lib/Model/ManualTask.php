...
class ManualTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'int',
        'actions' => '\VRPayment\Sdk\Model\ManualTaskAction[]',
        'created_on' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets state
     *
     * @return \VRPayment\Sdk\Model\ManualTaskState|null
     */
     ...
     * Sets state
     *
     * @param \VRPayment\Sdk\Model\ManualTaskState|null $state state
     *
     * @return self
     */
     ...
     * Gets actions
     *
     * @return \VRPayment\Sdk\Model\ManualTaskAction[]|null
     */
     ...
     * Sets actions
     *
     * @param \VRPayment\Sdk\Model\ManualTaskAction[]|null $actions The actions that can be triggered to handle the manual task.
     *
     * @return self
     */
